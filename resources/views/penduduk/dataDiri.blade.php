            ...
            <div class="card">
                <div class="card-body">
                    <div class="profile-sidebar">
                        ...
                        <div class="row">
                            <div class="col">
                                <img src="{{asset('img/pic.jpg')}}" class="img-responsive" alt="" width="100%">
                            </div>
                        </div>
                        <!-- END SIDEBAR USERPIC -->
                        <!-- SIDEBAR USER TITLE -->
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {{Form::label('nik', 'NIK');}}
                        {{Form::text('nik',$id->nik,array('class'=>'form-control','autofocus','disabled')) }}
                        <span class="text-danger">{{ $errors->first('nik') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('nama', 'Nama');}}
                        {{Form::text('nama',$id->nama,array('class'=>'form-control','disabled')) }}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('tempatLahir',$id->tempatLahir,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('tempatLahir') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('tanggalLahir', 'Tanggal Lahir');}}
                        {{Form::date('tanggalLahir',$id->tanggalLahir,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('tanggalLahir') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('agama', 'Agama');}}
                        {{Form::text('agama',$id->agama,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('agama') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('pendidikan', 'Pendidikan');}}
                        {{Form::text('pendidikan',$id->pendidikan,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('pendidikan') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('pekerjaan', 'Pekerjaan');}}
                        {{Form::text('pekerjaan',$id->pekerjaan,array('class'=>'form-control','disabled')) }}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('status',$id->status,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('status') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('hubungan', 'Hubungan Dalam Keluarga');}}
                        {{Form::text('hubungan',$id->hubungan,array('class'=>'form-control','disabled')) }}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('ayah',$id->ayah,array('class'=>'form-control','disabled')) }}
                        <span class="text-danger">{{ $errors->first('ayah') }}</span>
                    </div>
                    <div class="form-group">
                        {{Form::label('ibu', 'ibu');}}
                        {{Form::text('ibu',$id->ibu,array('class'=>'form-control','disabled')) }}
